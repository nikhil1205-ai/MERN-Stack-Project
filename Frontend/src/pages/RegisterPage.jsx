      ...
      <div className="mx-auto flex min-h-screen max-w-md items-center px-6 py-12">
        <div className="w-full rounded-[2rem] border border-slate-200 bg-white p-10 shadow-[0_40px_80px_rgba(56,189,248,0.12)]">
          <div className="mb-8">
            ...
            <h1 className="mt-4 text-3xl font-semibold text-slate-900">Welcome to ConnectSphere</h1>
            <p className="mt-3 text-sm text-slate-600">Create your profile and start sharing premium mock stories.</p>
          </div>
          ...
          <div className="mt-8 flex flex-col gap-3 text-sm text-slate-600 sm:flex-row sm:justify-between">
            <Link className="text-sky-700 transition hover:text-sky-900" to="/login">Already have an account?</Link>
